    ...
    <div class="wrap">
      ...
      <div class=" board_wrap">
        ...
        ?> 
          ...
          <ul>
              <li class="item item4">
                  <div class="image" style = "background-image: url(menu_image/menu1.png);"></div>
                  <div class="cont">
                      <strong>카구리 라면</strong>
                      <p>요즘 핫한 카구리 라면</p>
                      <a href="menu1.html">바로가기</a>
                  </div>
              </li>
              <li class="item item5">
                  <div class="image" style = "background-image: url(menu_image/menu2.png);">사진</div>
                  <div class="cont">
                      <strong>숙주사키 라면</strong>
                      <p>숙주사키 라면</p>
                      <a href="menu2.html">바로가기</a>
                  </div>
              </li>
              <li class="item item6">
                  <div class="image" style = "background-image: url(menu_image/menu3.png);">사진</div>
                  <div class="cont">
                      <strong>짜계치 라면</strong>
                      <p>짜파게티 + 계란 + 치즈의 환상조합</p>
                      <a href="menu3.html">바로가기</a>
                  </div>
              </li>
          </ul>
      </div>
