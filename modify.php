        ...
        <div class="board_title">
          ...
          <p> 각 PC방에 공지사항을 확인하세요 </p>
                ...
                <?php
                    ...
                    $sql = mq("SELECT * FROM pcarea_notice WHERE notice_number= '".$bno."';");
                ...
                ?> 
                    ...
                    <div id="write_area">
                        <form action="modify_ok.php?notice_number=<?php echo $bno; ?>" method="post">

                            <div id="in_title">
                                <textarea name="title" id="utitle" rows="1" cols="55" placeholder="제목" maxlength="100" required><?php echo $board['notice_title']; ?></textarea>
                            </div>
                            <div class="wi_line"></div>
                            <div id="in_name">
                                <textarea name="name" id="uname" rows="1" cols="55" placeholder="글쓴이" maxlength="100" required><?php echo $board['notice_writer']; ?></textarea>
                            </div>
                            <div class="wi_line"></div>
                            <div id="in_content">
                                <textarea name="content" id="ucontent" placeholder="내용" required><?php echo $board['notice_contents']; ?></textarea>
                            </div>
                            <div id="in_pw">
