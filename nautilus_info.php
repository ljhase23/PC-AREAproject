    ...
    <div class="wrap">
      ...
      <div class=" board_wrap">
        <div class="board_title">
          <strong> 노틸러스 PC방 춘천본점</strong>
          <p> 강원도 춘천시 효자로 143 2층</p>
        </div>
      <div style = "width: 100%;"id="daumRoughmapContainer1666688322004" class="root_daum_roughmap root_daum_roughmap_landing"></div>
      <script charset="UTF-8" class="daum_roughmap_loader_script" src="https://ssl.daumcdn.net/dmaps/map_js_init/roughmapLoader.js"></script>
      <script charset="UTF-8">
        new daum.roughmap.Lander({
          "timestamp" : "1666688322004",
          "key" : "2c7m4",
          "mapWidth" : "",
          "mapHeight" : "500"
        }).render();
      ...
      <br>
        <div class="list_wrap">
          <ul>
              <li class="item item1">
                  <div class="image" style= "background-image: url(pc_image/nautilus/nautilus_logo.png);"></div>
                  <div class="cont">
                      <strong style = "text-align: center;">PC방 로고</strong>
                  </div>
              </li>
              <li class="item item2">
                  <div class="image" style= "background-image: url(pc_image/nautilus/nautilus.png);">사진</div>
                  <div class="cont">
                      <strong style="text-align: center;">내부 사진</strong>
                  </div>
              </li>
              <li class="item item3">
                  <div class="image" style= "background-image: url(pc_image/nautilus/nautilus_road.png);">사진</div>
                  <div class="cont">
...
<br>
          <div class="bt_wrap">
            ...
            <a href="nautilus_info.php">새로고침</a>
